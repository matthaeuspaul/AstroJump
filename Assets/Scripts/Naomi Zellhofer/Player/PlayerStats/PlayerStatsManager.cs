...
public class PlayerStatsManager : MonoBehaviour
{
    ...
    // this method is written by Lucas Pietruschka to fix a bug caused by the GameOverScreen being inactive at start
    ...
    // end Part written by Matthäus Paul
}
